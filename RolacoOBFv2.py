...
class RolacoOBFv2:
    ...
    def _remove_comments_and_docstrings(self) -> None:
        ...
        tree.body.insert(0, ast.Expr(
                    value=ast.Constant(":: You managed to break through RolacoOBF v2; Give yourself a pat on your back! ::")
                ))
    ...
    def _obfuscate_vars(self) -> None:
        ...
        class Transformer(ast.NodeTransformer):
            def __init__(self, outer: RolacoOBFv2) -> None:
                self._outer = outer
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        description="RolacoOBF v2: Obfuscates Python code to make it unreadable and hard to reverse."
    )
    ...
    obfuscator = RolacoOBFv2(contents, args.include_imports, int(args.recursive) if args.recursive else 1)
